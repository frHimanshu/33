...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: VerificationCodeScreenWidget.routeName,
          path: VerificationCodeScreenWidget.routePath,
          builder: (context, params) => VerificationCodeScreenWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: UpcommingDeparturesScreenWidget.routeName,
          path: UpcommingDeparturesScreenWidget.routePath,
          builder: (context, params) => UpcommingDeparturesScreenWidget(),
        ),
        FFRoute(
          name: LocationScreenWidget.routeName,
          path: LocationScreenWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'LocationScreen')
        ...
        FFRoute(
          name: MyProfileScreenWidget.routeName,
          path: MyProfileScreenWidget.routePath,
          builder: (context, params) => MyProfileScreenWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => BookmarkScreenWidget(),
        ),
        FFRoute(
